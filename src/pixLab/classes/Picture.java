...
public class Picture extends SimplePicture 
{
  ...
  public void rotateColorFilter()
  {
	  ...
	  for(int row=0; row<pixels.length; row++)
	  {
		  for(int col = 0; col<pixels[0].length; col++)
		  {
			  int oldRed = pixels[row][col].getRed();
			  int oldBlue = pixels[row][col].getBlue();
			  int oldGreen = pixels[row][col].getGreen();
...
//			  blackCount++;
  ...
  public void grayscale()
  {
	  ...
	  for(Pixel[] rowArray : pixels)
	  {
		  for(Pixel pixelObj : rowArray)
		  {
			  int averagePixelColor = (pixelObj.getBlue()+pixelObj.getRed()+pixelObj.getGreen())/3;
			  pixelObj.setRed(averagePixelColor);
			  pixelObj.setBlue(averagePixelColor);
			  pixelObj.setGreen(averagePixelColor);
